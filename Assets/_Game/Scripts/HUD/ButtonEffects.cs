...
public class ButtonEffects : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    //Variables
    [Header("Settings")]
    [SerializeField] private bool m_triggerSFX = true;
    [SerializeField] private bool m_resetScaleOnEnable = true;
    ...
    {
        if (m_resetScaleOnEnable) transform.localScale = Vector3.one;
        m_selected = false;
    }
